...
{ 
    ...
    $admin_fullname = $_SESSION['admin_fullname']; // Retrieve admin username from session
    echo "<div style='background-color: lightgreen; padding: 10px; text-align: center;'><strong>Welcome, $admin_fullname!</strong></div>";
  }
...
<head>
    ...
    <title>BookNest | Manage Issued Books</title>
